...
import alex.deeplearning.utils.DataUtilities;
import alex.deeplearning.utils.SentimentExampleIterator;
...
public class SentimentsApp {
    ...
    public static final String WORD_VECTORS_PATH = "/home/alex/Downloads/GoogleNews-vectors-negative300.bin.gz";
    ...
    public static void main(String[] args) throws Exception {
        ...
        long numOfOutputs = networkOutput.size(2);
